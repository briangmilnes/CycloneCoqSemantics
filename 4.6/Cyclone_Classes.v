...
Class TypJudgement (In: Type) := { typ' : Delta -> Upsilon -> Gamma -> In -> Tau -> Prop;
                                   D'   : Heap -> In -> Heap -> In -> Prop}.

Instance RtypJudgement : TypJudgement E  := {typ' := rtyp; D' := R}.
Instance LtypJudgement : TypJudgement E  := {typ' := ltyp; D' := L}.
Instance StypJudgement : TypJudgement St := {typ' := styp; D' := S}.
...
(* As used for static semanctics induction *)
...
(* as used for dynamic semantics induction *)
       | H : context[?P _ RtypJudgement _ _ _ _ _ ]|- _  => unfold P in H
       |  |- context[?P _ RtypJudgement _ _ _ _ _ ]      => unfold P

       | H : context[?P _ LtypJudgement _ _ _ _ _ ]|- _  => unfold P in H
       |  |- context[?P _ LtypJudgement _ _ _ _ _ ]      => unfold P                                                                  
       | H : context[?P _ StypJudgement _ _ _ _ _ ]|- _  => unfold P in H
       |  |- context[?P _ StypJudgement _ _ _ _ _ ]      => unfold P
...
Ltac simpl_classes_funs :=
   repeat 
     match goal with
       ...
       | H : context[D' _ _ _ _ ] |- _ => unfold D' in H
       |  |- context[D' _ _ _ _ ]      => unfold D'
     end.

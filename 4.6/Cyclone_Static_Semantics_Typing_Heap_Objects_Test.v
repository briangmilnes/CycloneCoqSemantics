...
Example gettype_empty_test2:
  gettype LVPE.V.empty varx nil tau nil tau.
Proof.
  auto.
Qed.
...
Example gettype_etype_test2:
  gettype (LVPE.V.empty &p (varx, pdot) ~p cint) varx pdot 
...
Example gettype_left_test2:
  gettype LVPE.V.empty varx nil (cross cint cint) (cons (i_pe zero_pe) nil) cint.
Proof.   
...
Example gettype_right_test2:
  gettype LVPE.V.empty varx nil (cross cint cint) (cons (i_pe one_pe) nil) cint.
Proof.
  auto.
Qed.

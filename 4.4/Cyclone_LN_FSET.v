...
Lemma subset_union_3p : forall E1 E2 E3 F1 F2 F3 G : vars,
  E1 \c (F1 \u G) -> E2 \c (F2 \u G) -> E3 \c (F3 \u G) ->
 (E1 \u E2 \u E3) \c ((F1 \u F2 \u F3) \u G).
Proof.
  introv H1 H2 H3. intros x.
  specializes H1 x.
  specializes H2 x.
  specializes H3 x.
  repeat rewrite in_union in *.
...
Hint Resolve subset_union_weak_l subset_union_weak_r subset_refl
  subset_union_2 subset_union_2p subset_union_3p subset_empty_l 

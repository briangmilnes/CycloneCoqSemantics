...
Hint Extern 4 (S _ _ _ _) => constructors~.
Hint Extern 4 (R _ _ _ _) => constructors~.
Hint Extern 4 (L _ _ _ _) => constructors~.
Hint Extern 4 (R _ (e_s (p_e (fevar _) _)) _ (e_s _)) => applys~ R_get_3_1.

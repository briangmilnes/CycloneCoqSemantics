...
| S_openstar_3_8: forall (tau tau' : Tau) (v v' : E) (q : Phi) (k : Kappa) (alpha : TVar) (x x': EVar) (h : Heap) (s : St) (p : Pth.Path),
                    Value v ->
                    x <> x' ->
...
| S_open_3_9_5: forall (h h' : Heap) (e e' : E) (x : EVar) (alpha : TVar) (s : St),
                   R h (e_s e) h' (e_s e') ->
...
| S_openstar_3_11: forall (h h' : Heap) (e e' : E) (x : EVar) (alpha : TVar) (s : St),
                        L h  (e_s e) h' (e_s e') ->
                        S h  (openstar e  alpha x s)
                          h' (openstar e' alpha x s)

with R : Heap -> St -> Heap -> St -> Prop :=
 | R_get_3_1 : forall (h  : Heap) (x : EVar) (p : Pth.Path) (v v' : E),
                    H.map h x = Some v' -> 
                    get v' p v ->
                    Value v ->
                    Value v' ->
 ...
 | R_assign_3_2:
     forall (h' h : Heap) (v v' v'' : E) (x : EVar) (p : Pth.Path),
       H.map h x = Some v' ->
       set v' p v v'' ->
       H.add h x v'' = h' -> 
       Value v   ->
 ...
 | R_star_amp_3_3:  
                 forall (h : Heap) (x : EVar) (p : Pth.Path),
 ...
 | R_inst_3_7:  forall (h : Heap) (alpha : TVar) (k : Kappa) (f : F) (tau : Tau),
 ...
 | R_assign_3_10_3: forall (h h' : Heap) (e e' : E) (x : EVar) (p : Pth.Path),
                    R h (e_s e) h' (e_s e') ->
 ...
 | R_pack_3_10_5:  forall (h h' : Heap) (e e' : E) (tau tau' : Tau) (p : Phi) (k : Kappa) (alpha : TVar),
                    R h (e_s e)        h' (e_s e') ->
...
with L : Heap -> St -> Heap -> St -> Prop :=
 ...
 | L_xpi_3_1: forall (h : Heap) (x : EVar) (p : Pth.Path) (ipe : Pth.IPE),
                L h (e_s (dot (p_e x p) ipe))
                  h (e_s (p_e x (p ++ [Pth.i_pe ipe])))

 | L_staramp_3_2: forall (h : Heap) (x : EVar) (p : Pth.Path),

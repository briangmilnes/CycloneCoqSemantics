...
Lemma open_close_var : forall alpha t, 
  lc t -> 
  open (ftvar alpha) (close alpha t)  = t.
Proof.
  introv T. unfold open, close. generalize 0.
...
Lemma open_var_fv : forall x t,
  fv (open_rec 0 (ftvar x) t) \c (fv t \u \{x}).
...
Lemma close_fv : forall x t,
  fv (close_rec 0 x t) \c (fv t \- \{x}).
Proof.
  introv. unfold close. generalize 0.
...
Lemma subst_open_rec :
  forall alpha u t v, 
    lc u -> 
    subst u alpha (open_rec 0 v t) =
    open_rec 0 (subst u alpha v) (subst u alpha t).
Proof.
  intros. generalize 0.
  induction t; intros; simpl; fequals~.
  case_nat~.
...
Lemma subst_close_rec:
  forall alpha beta u t, 
    alpha <> beta ->
    beta \notin fv u -> 
    subst u alpha (close_rec 0 beta t) = close_rec 0 beta (subst u alpha t).
Proof.
...
Lemma subst_intro_alternative : forall alpha t u, 
  alpha \notin (fv t) -> 
  open_rec 0 u t = subst u alpha (open_rec 0 (ftvar alpha) t).
Proof.
...
Lemma close_rename : forall alpha beta t,
  alpha \notin fv t ->
  close_rec 0 beta t =
  close_rec 0 alpha (subst (ftvar alpha) beta t).
Proof.
  introv.  generalize 0.
...
Lemma size_open_rec : forall alpha t,
  size (open_rec 0 (ftvar alpha) t) = size t.
Proof.
  intros. generalize 0.
...
Lemma size_close_rec : forall alpha t,
  size (close_rec 0 alpha t) = size t.
Proof.
  intros. generalize 0.

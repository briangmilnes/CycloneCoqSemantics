...
Hint Extern 1 (ok empty) => idtac "(ok empty)"; trace_goal; apply ok_empty.
Hint Extern 1 (ok empty) => idtac "(ok empty)"; trace_goal; apply ok_empty.
Hint Extern 1 (ok empty) => idtac "(ok empty)"; trace_goal; apply ok_empty.
Hint Extern 1 (ok nil) => idtac "(ok empty)"; trace_goal;  rewrite <- empty_def; apply ok_empty.
Hint Extern 1 (LVPE.okp LVPE.V.empty) => idtac "(LVPE.okp LVPE.V.empty)"; trace_goal; apply LVPE.okp_empty.
Hint Extern 1 (LVPE.okp nil) => idtac "(LVPE.okp LVPE.V.empty)"; trace_goal; rewrite <- empty_def; apply LVPE.okp_empty.
